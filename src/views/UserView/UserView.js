...
function getUserFeed(name) {
  const options = {
    method: "GET",
    url: `https://tiktok33.p.rapidapi.com/user/feed/${name}`,
    headers: {
      "x-rapidapi-host": "tiktok33.p.rapidapi.com",
      "x-rapidapi-key": "c1257dc04cmshd888bbb072eb770p1f2b8ajsnbf16d4cd1d66",
    },
...
const UserView = () => {
  ...
  useEffect(() => {
    getUserDetails(name).then((response) => {
  ...
  //         console.log(`getUserFeed`,response.data);
  //         setUserFeed(response.data);
  //         console.log(`setUserFeed`,setUserFeed);
  //
  //     });
  // }, [])
  ...
  return (
    <>
      <UserProfile key={userDetail} name={name} userDetail={userDetail} />
